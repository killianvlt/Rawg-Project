...
export default function Introduction() {
  return (
    <>
      <h2 className="text-4xl text-white mt-10">Welcome,</h2>
      <p className="text-xl text-white leading-9 mt-5">
        ...
        and social influencers providing unprecedented exposure to the entire
        video game industry, all under one roof. This text seems familiar.
      </p>
    </>
  )
}
